...
const Profile = () => {
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast.error(errorData.message || 'Profile update failed. Please try again.');
            }
        } catch (err) {
    ...
    return (
        <section className="w-full">
            ...
            <div
                className="w-screen bg-cover bg-center relative flex items-center justify-center"
                style={{
                    ...
                    <form onSubmit={handleUpdateProfile}>
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`w-full px-3 py-2 border rounded ${provider === 'google'
                        ...
                        {provider === 'google' && (
                            <p className="mt-4 mb-2 text-sm text-gray-700 italic">
