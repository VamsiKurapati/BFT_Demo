        ...
        <section className="w-full font-goudy">
          ...
          <section className="flex flex-col md:flex-row items-center justify-center md:justify-between p-6 md:p-12 pl-8 sm:pl-16 md:pl-20 lg:pl-24 bg-white">
            ...
            <div className="md:w-[70%] space-y-1">
              <h2 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[40px] font-archivo-black font-weight-400 text-[#003566E5]">
                Why Blind Fold Trips?
              </h2>
              <p className="text-[#00474CBF] text-[20px] md:text-[24px] font-baloo-bhai font-weight-400">
              ...
              />
              <p className="font-poppins font-weight-400 text-[20px] text-[#000000CC] leading-relaxed">
                  Imagine showing up at the airport with your bags packed, boarding pass in hand,
                  and no idea where you're flying.
                  <span className="font-weight-600 text-[#000000]">
          ...
          <section className="relative bg-[#D9D9D966] py-12 px-4 mb-12 sm:px-12 lg:px-24">
            <h2 className="text-3xl text-[40px] text-[#003566E5] font-archivo-black font-weight-400 mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="relative bg-white rounded-2xl overflow-hidden border border-12 border-[#FFBE55] shadow-sm hover:shadow-lg transition">
                <div className="relative h-[145px] bg-cover bg-center rounded-2xl" style={{ backgroundImage: "url('/img4.jpg')" }} >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <h3 className="text-[20px] font-poppins font-weight-700 text-[#FFFFFF] text-center z-10">
                      100% Mystery
                    </h3>
                  </div>
                </div>
                <div className="p-4 text-center">
                  <p className="mt-4 font-poppins font-weight-400 text-[12px] text-[#000000CC]">
                    <span className="font-weight-600 text-[#000000]">You won’t know where you’re going until the very last moment.</span> Your trip is custom-curated, but the destination stays top-secret until the reveal. <span className="font-weight-600 text-[#000000]">It’s like unwrapping a present</span>—you just happen to fly there.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-yellow-400 shadow-sm hover:shadow-lg transition">
                ...
                <div className="p-4 text-center">
                  <p className="mt-4 font-poppins font-weight-400 text-[12px] text-[#000000CC]">
                    <span className="font-weight-600 text-[#000000]">Forget the stress</span> of booking flights, hotels, or activities. We handle it all, down to the details. <span className="font-weight-600 text-[#000000]">You just pack, trust the process, and go.</span>
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-yellow-400 shadow-sm hover:shadow-lg transition">
                ...
                <div className="p-4 text-center">
                  <p className="mt-4 font-poppins font-weight-400 text-[12px] text-[#000000CC]">
                    ...
                    <span className="font-weight-600 text-[#000000]"> we design your trip based on your travel style, preferences, and comfort level.</span>
              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-yellow-400 shadow-sm hover:shadow-lg transition">
                ...
                <div className="p-4 text-center">
                  <p className="mt-4 font-poppins font-weight-400 text-[12px] text-[#000000CC]">
                    <span className="font-weight-600 text-[#000000]">We’re here for the goosebumps.</span> The excitement. The jaw-drops. The laughs. The kind of stories that begin with “You won’t believe what happened…”
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              <div className="z-20 flex-1">
                <h2 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-archivo-black font-weight-400 font-bold text-[#003566E5] mb-4">
                  Who’s This For?
                </h2>

                <ul className="space-y-2 text-[15px] sm:text-[16px] md:text-[19px] text-[#000000BF] font-poppins font-weight-400">
                  <li>
                    <span className="text-[#000000] font-weight-600">Free spirits and thrill-seekers</span> who live for the
                    unknown.
                  </li>
                  <li>
                    <span className="text-[#000000] font-weight-600">Romantic couples</span> looking to spice things up with
                    a mystery escape.
                  </li>
                  <li>
                    <span className="text-[#000000] font-weight-600">Curious explorers</span> who want something different
                    from cookie-cutter vacations.
                  </li>
                  <li>
                    <span className="text-[#000000] font-weight-600">Overworked minds</span> who just need a break—from both
                    routine and decision-making.
                  </li>
                </ul>

                <p className="mt-6 text-base sm:text-[17px] md:text-[28px] lg:text-[34px] font-poppins font-weight-700 leading-relaxed">
                ...
                <button className="mt-6 bg-[#A11616E5] text-[#FCD2B1] px-5 py-2.5 rounded-lg font-poppins font-weight-700 text-[15px] md:text-[19px] shadow-md">
          ...
          <section className="relative py-12">
            ...
            <div className="container relative mx-auto z-20 pl-[48px] lg:pl-[72px]">
              <div className="mb-8">
                  <h2 className="font-archivo-black font-weight-400 text-[32px] md:text-[40px] text-[#003566E5]">Real Trips. Real Stories. Real Wow</h2>
              </div>
              ...
              <div className="md:w-[70%] mt-8 mb-8">
                  <h2 className="font-archivo-black font-weight-400 text-[32px] md:text-[40px] text-[#003566E5]">Ready to Let Go and Let Adventure Take Over?</h2>
                  <p className="mt-2 text-[#000000CC] font-poppins font-weight-400 text-[20px]">
                  ...
                  <button className="mt-4 bg-[#A11616E5] text-[#FCD2B1] px-6 py-2 font-poppins font-weight-400 text-[20px] rounded-xl">
                    Start Your Mystery Trip
                  </button>
              </div>
